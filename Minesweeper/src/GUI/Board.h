...
public:
	...
	void setCol(int num) { col = num; }
	void setBombCount(int num) { BombCount = num; }
	void setFlagCount(int num) { FlagCount = num; }
	void setOpenBlankCount(int num) { OpenBlankCount = num; }
	void setRemainBlankCount(int num) { RemainBlankCount = num; }
	...
	int getOpenBlankCount() { return OpenBlankCount; }
	int getRemainBlankCount() { return RemainBlankCount; }
