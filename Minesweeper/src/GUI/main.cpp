...
// For debuging
#define INIT_MODE GUI

// Global values : These values are shared with other files in the project.
ifstream iFile;
ofstream oFile;
int ioMode = mode::INIT_MODE;

int main(int argc, char* argv[])
{
	// Record IO mode.
	if (argc == 1) { ioMode = INIT_MODE; }
	else if (argc == 3 && strcmp(argv[1], "CommandFile") == 0) { ioMode = fileIO; }
